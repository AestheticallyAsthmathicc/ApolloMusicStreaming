			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="loginUsername" name="loginUsername" type="text" placeholder="e.g jonSnow" value="<?php getInputValue('loginUsername') ?>" required>
					</p>
					...
					<div class="hasAccount">
						<span id="hideLogin">
							Dont't have an account yet? Signup here.
						</span>
					</div>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="email2" name="email2" type="email" placeholder="e.g. jonSnow@gmail.com" value="<?php getInputValue('email2') ?>" required>
					</p>
